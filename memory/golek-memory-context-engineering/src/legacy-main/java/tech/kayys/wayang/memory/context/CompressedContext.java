...
public class CompressedContext {
    ...
    public int getOriginalMemoryCount() {
        return originalMemoryCount;
    }

    public int getCompressedUnitCount() {
        return compressedUnitCount;
    }
    ...
    public double getInformationRetention() {
