...
final public class WayangPlatformJsonSchemaProperties {

    private WayangPlatformJsonSchemaProperties() {
    }

    public  static Map<String, Object> compactStatusProperties() {
    ...
    public static Map<String, Object> statusProperty() {
        Map<String, Object> properties = new LinkedHashMap<>();
        properties.put("product", WayangJsonSchemaDocuments.stringProperty());
        properties.put("version", WayangJsonSchemaDocuments.stringProperty());
    ...
    public static Map<String, Object> catalogProperties() {
        Map<String, Object> properties = new LinkedHashMap<>();
        properties.put("product", WayangJsonSchemaDocuments.stringProperty());
    ...
    public static Map<String, Object> profileListProperties() {
        Map<String, Object> properties = new LinkedHashMap<>();
        properties.put("product", WayangJsonSchemaDocuments.stringProperty());
    ...
    public static Map<String, Object> profileDetailProperties() {
        Map<String, Object> properties = new LinkedHashMap<>();
        properties.put("product", WayangJsonSchemaDocuments.stringProperty());
    ...
    public static Map<String, Object> sdkBoundaryCatalogProperties() {
        Map<String, Object> properties = new LinkedHashMap<>();
        properties.put("product", WayangJsonSchemaDocuments.stringProperty());
    ...
    public static Map<String, Object> sdkBoundaryDetailProperties() {
        Map<String, Object> properties = new LinkedHashMap<>();
        properties.put("product", WayangJsonSchemaDocuments.stringProperty());
    ...
    public static Map<String, Object> readinessProfileListProperties() {
        Map<String, Object> properties = new LinkedHashMap<>();
        properties.put("product", WayangJsonSchemaDocuments.stringProperty());
        properties.put("totalProfiles", WayangJsonSchemaDocuments.nonNegativeIntegerProperty());
    ...
    public static Map<String, Object> readinessProfileDetailProperties() {
        Map<String, Object> properties = new LinkedHashMap<>();
        properties.put("product", WayangJsonSchemaDocuments.stringProperty());
        properties.put("profileId", WayangJsonSchemaDocuments.stringProperty());
    ...
    public static Map<String, Object> readinessProfileValidationProperties() {
        Map<String, Object> properties = new LinkedHashMap<>();
        properties.put("product", WayangJsonSchemaDocuments.stringProperty());
    ...
    public static Map<String, Object> readinessProfileValidationPolicyListProperties() {
        Map<String, Object> properties = new LinkedHashMap<>();
        properties.put("product", WayangJsonSchemaDocuments.stringProperty());
    ...
    public static Map<String, Object> readinessProfileRegistryResolutionProperties() {
        Map<String, Object> properties = new LinkedHashMap<>();
        properties.put("product", WayangJsonSchemaDocuments.stringProperty());
        properties.put("valid", WayangJsonSchemaDocuments.booleanProperty());
    ...
    public static Map<String, Object> readinessProfileRegistryConfigDiagnosticsProperties() {
        Map<String, Object> properties = new LinkedHashMap<>();
        properties.put("product", WayangJsonSchemaDocuments.stringProperty());
        properties.put("valid", WayangJsonSchemaDocuments.booleanProperty());
        properties.put("issueCount", WayangJsonSchemaDocuments.nonNegativeIntegerProperty());
    ...
    public static Map<String, Object> catalogProperty() {
        return WayangJsonSchemaDocuments.objectProperty(
