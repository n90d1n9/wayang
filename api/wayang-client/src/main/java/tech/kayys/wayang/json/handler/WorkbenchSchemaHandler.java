...
public class WorkbenchSchemaHandler implements SchemaHandler {

    private static final String DOMAIN_ID = "workbench";
    private static final String DESCRIPTION = "Wayang workbench schema";
    ...
    public Map<String, Object> buildSchema() {
        ...
        schema.put("title", "Workbench Schema");
