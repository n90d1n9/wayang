...
public final class AgentRunMetadata {
    ...
    public static final String WAYANG_PROFILE = "wayang.profile";

    private AgentRunMetadata() {
    }

    public static String tenant(AgentRunStatus status) {
        return value(status, TENANT, TENANT_ID);
    }

    public static String session(AgentRunStatus status) {
        return value(status, SESSION, SESSION_ID);
    }

    public static String surface(AgentRunStatus status) {
        return value(status, SURFACE, SURFACE_ID);
    }

    public static String profile(AgentRunStatus status) {
        return value(status, PROFILE, PROFILE_ID, WAYANG_PROFILE);
    }

    public static String profile(Map<String, Object> metadata) {
        return value(metadata, PROFILE, PROFILE_ID, WAYANG_PROFILE);
    }

    public static String profileContext(Map<String, Object> context) {
        return value(context, WAYANG_PROFILE, PROFILE, PROFILE_ID);
    }

    public static void putProfileAliases(Map<String, Object> metadata, String profileId) {
        if (metadata == null) {
            return;
        }
    ...
    public static boolean matches(AgentRunStatus status, String expected, String... keys) {
    ...
    public static Map<String, Integer> count(List<AgentRunStatus> statuses, Function<AgentRunStatus, String> classifier) {
    ...
    public static String value(AgentRunStatus status, String... keys) {
        return status == null ? "" : value(status.metadata(), keys);
    }

    public static String value(Map<String, Object> metadata, String... keys) {
