...
public class CommandSchemaHandler implements SchemaHandler {

    private static final String DOMAIN_ID = "command";
    private static final String DESCRIPTION = "Wayang command discovery schema";
    ...
    public Map<String, Object> buildSchema() {
        ...
        schema.put("title", "Command Schema");
