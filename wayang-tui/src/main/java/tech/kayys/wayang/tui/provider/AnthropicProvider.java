...
import tech.kayys.wayang.tui.http.SseReader;
...
public final class AnthropicProvider implements Provider {
    ...
    private final Config.ProviderConfig config;
    private final String apiKey;
    private final String model;
    private final HttpClient http;

    public AnthropicProvider(Config.ProviderConfig config, String model) {
        this.config = config;
        this.model = model;
        this.apiKey = Config.resolveApiKey(config);
    ...
    public void streamChat(
        ...
        if (apiKey == null) {
            onEvent.accept(new StreamEvent.Error(
                    "No API key found for provider 'anthropic'. Set " + config.apiKeyEnv + "."));
            return;
        }
