...
/**
 * Validation result for a framework-neutral Agentic Commerce HTTP request.
 */
public record AgenticCommerceValidationReport(
        AgenticCommerceHttpRequest request,
        Optional<AgenticCommerceHttpRoute> route,
        List<AgenticCommerceValidationIssue> issues) {

    public AgenticCommerceValidationReport {
