...
final class SdkCounts {

    private SdkCounts() {
    }

    static Map<String, Integer> copy(Map<String, Integer> values) {
    ...
    static Map<String, Integer> copyPositiveTextKeys(Map<String, Integer> values) {
        if (values == null || values.isEmpty()) {
            return Map.of();
        }
    ...
    static <K> Map<K, Integer> copyPositiveKeys(Map<K, Integer> values) {
        if (values == null || values.isEmpty()) {
            return Map.of();
        }
