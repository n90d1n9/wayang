 ...
 */
public final class SpecAlignmentProjection {

    private SpecAlignmentProjection() {
    }

    public static Map<String, Object> report(WayangA2uiSpecAlignmentReport report) {
        ...
        values.put("requirements", resolved.requirements().stream()
                .map(SpecAlignmentProjection::requirement)
                .toList());
        return ProjectionMaps.freeze(values);
    }

    public static Map<String, Object> standardDescriptor() {
        Map<String, Object> values = new LinkedHashMap<>();
    ...
    public static Map<String, Object> requirement(WayangA2uiSpecAlignmentRequirement requirement) {
    ...
    public static Map<String, Object> routeExpectation(WayangA2uiHttpRoute route) {
    ...
    public static Map<String, Object> routeActual(
    ...
    public static boolean pathSuffixMatches(String expectedPath, String actualPath) {
        String suffix = routeSuffix(expectedPath);
        String actual = DecodeValues.text(actualPath);
        String expected = DecodeValues.text(expectedPath);
        return actual.equals(expected) || actual.endsWith(suffix);
    }

    private static String routeSuffix(String path) {
        String normalized = DecodeValues.text(path);
