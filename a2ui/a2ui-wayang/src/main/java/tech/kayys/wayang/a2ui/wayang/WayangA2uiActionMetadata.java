 ...
 */
final class WayangA2uiActionMetadata {

    private WayangA2uiActionMetadata() {
    }

    static Map<String, Object> inspection(AgentRunInspection inspection) {
    ...
    static Map<String, Object> history(AgentRunHistory history) {
    ...
    static Map<String, Object> events(AgentRunEvents events) {
    ...
    static Map<String, Object> waitResult(AgentRunWaitResult result) {
    ...
    static Map<String, Object> cancelResult(AgentRunCancelResult result) {
