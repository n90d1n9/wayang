...
/**
 * Artifact store with a primary backend and a fallback backend.
 */
public final class HybridSkillArtifactStore implements SkillArtifactStore {

    private final SkillArtifactStore primary;
    private final SkillArtifactStore fallback;

    public HybridSkillArtifactStore(SkillArtifactStore primary, SkillArtifactStore fallback) {
