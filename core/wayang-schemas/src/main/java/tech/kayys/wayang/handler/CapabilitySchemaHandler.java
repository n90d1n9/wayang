...
public class CapabilitySchemaHandler implements SchemaHandler {

    private static final String DOMAIN_ID = "capability";
    private static final String DESCRIPTION = "Wayang provider capability schema";
    ...
    public Map<String, Object> buildSchema() {
        ...
        schema.put("title", "Capability Schema");
