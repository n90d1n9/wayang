 ...
 *
 * <p>
 * Splits YAML frontmatter (between {@code ---} delimiters) from the
 * markdown body and constructs a {@link SkillManifest}.
 *
 * <h3>Format:</h3>
 * 
 * <pre>
...
public final class SkillManifestParser {
     ...
     * Expects structure: {@code baseDir/skills/skill-name/SKILL.md} or
     * {@code baseDir/skill-name/SKILL.md}.
     *
    ...
    public static List<SkillManifest> scanDirectory(Path baseDir) {
        ...
        // Try skills/ subdirectory first (cc-skills convention)
