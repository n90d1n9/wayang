...
public record McpServerActionPreview(
    ...
    static final String STATUS_AUTOMATABLE = McpServerActionPreviewStatus.AUTOMATABLE;
    @Deprecated(forRemoval = true)
    static final String STATUS_INVALID = McpServerActionPreviewStatus.INVALID;
    @Deprecated(forRemoval = true)
    static final String STATUS_MANUAL = McpServerActionPreviewStatus.MANUAL;
    @Deprecated(forRemoval = true)
    static final String STATUS_NOT_FOUND = McpServerActionPreviewStatus.NOT_FOUND;
    @Deprecated(forRemoval = true)
    static final String STATUS_REVIEW_REQUIRED = McpServerActionPreviewStatus.REVIEW_REQUIRED;
