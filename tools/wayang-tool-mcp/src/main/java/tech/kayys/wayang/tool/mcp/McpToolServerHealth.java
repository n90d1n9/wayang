...
public record McpToolServerHealth(
    ...
    public static final String ACTION_EXECUTION_AUTOMATABLE = McpServerActionExecutionMode.AUTOMATABLE;
    @Deprecated(forRemoval = true)
    public static final String ACTION_EXECUTION_MANUAL = McpServerActionExecutionMode.MANUAL;
    @Deprecated(forRemoval = true)
    public static final String ACTION_EXECUTION_REVIEW_REQUIRED = McpServerActionExecutionMode.REVIEW_REQUIRED;
