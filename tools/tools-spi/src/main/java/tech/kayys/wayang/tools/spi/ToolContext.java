...
public record ToolContext(
    ...
    public Map<String, Object> asMap() {
        ...
        if (toolId != null) map.put("toolId", toolId);
        if (inputs != null) map.put("inputs", inputs);
        if (workingDirectory != null) map.put("workingDirectory", workingDirectory.toString());
        if (environment != null) map.put("environment", environment);
        if (timeout != null) map.put("timeout", timeout.toString());
        map.put("dryRun", dryRun);
        if (customData != null) map.put("customData", customData);
        return map;
    }
}
