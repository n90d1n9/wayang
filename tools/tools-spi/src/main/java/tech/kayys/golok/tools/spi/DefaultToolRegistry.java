...
import tech.kayys.gollek.agent.tools.ToolCacheManager;
...
/**
 * Default implementation of {@link ToolRegistry} with caching support.
 *
 * <p>Features:
 * <ul>
 ...
 * <li>Integrated caching via {@link ToolCacheManager}</li>
 * <li>10x performance improvement for repeated executions</li>
 * </ul>
 *
 * @author golok Team
 * @version 2.0.0
...
public class DefaultToolRegistry implements ToolRegistry {
    ...
    public Uni<Map<String, Object>> execute(String toolId,
        ...
        return cacheManager.executeWithCache(
            toolId,
            params,
            context != null ? context.asMap() : Map.of(),
            () -> get(toolId)
                .map(tool -> tool.execute(params, context))
